...
INSERT INTO "new_User" ("createdAt", "email", "id", "isAdmin", "passwordHash", "usedInviteCodeId") SELECT "createdAt", "email", "id", "isAdmin", "passwordHash", "usedInviteCodeId" FROM "User";
DROP TABLE "User";
